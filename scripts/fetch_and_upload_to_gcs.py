...
def main(dataset_name: str):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        csv_file_path = download_csv(dataset_name=dataset_name, download_directory=temp_dir, download_csv_file_name=download_csv_file_name)
        parquet_dir = create_parquet_files(temporary_dir=temp_dir, csv_file_path=csv_file_path, schema=SCHEMA)
